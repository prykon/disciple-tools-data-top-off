...
class Disciple_Tools_Data_Top_Off_Site_Links {
    public $type = 'Disciple_Tools_Data_Top_Off';
    ...
    public function site_link_type( $type ) {
        $type[$this->type] = __( 'Data Top-Off' );
        return $type;
    }
}
Disciple_Tools_Data_Top_Off_Site_Links::instance();
